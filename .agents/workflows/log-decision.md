...
Transfer rule: when this workflow is copied into a new repository, start a fresh decision log or clearly archive imported decisions before adding new project entries.
