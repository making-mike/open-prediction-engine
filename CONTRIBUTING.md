...
OPE is currently a Python 3 standard-library project. There is no required package install step for normal checks and no third-party runtime dependency.
