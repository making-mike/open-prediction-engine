...
- `setup-engine.schema.json`: checked domain-agnostic setup-engine front door with candidate forecast contracts, source roles, baseline guidance, host-wrapper shape, examples, interface bindings, and claim boundaries.
...
- `setup-engine.md`: checked domain-agnostic setup-engine front door for agents adding prediction to any host project.
