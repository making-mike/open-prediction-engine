...
It materializes `forecast-1301` from the ready campaign runner decision in fixture mode. The artifact is unresolved, unscored, baseline-only, and bound to the campaign manifest and forecast-creation handoff as provenance. It does not write `.ope/live/`, fetch live data, run a resolver, append corpus evidence, or allow quality and calibration claims.
