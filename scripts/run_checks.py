...
CHECKS: list[list[str]] = [
    ...
    py("scripts/generate_prediction_goal_catalog.py", "--check"),
    py("scripts/check_prediction_goal_catalog.py"),
    py("scripts/generate_setup_engine.py", "--check"),
    py("scripts/check_setup_engine.py"),
    ...
    py("scripts/check_calibration_store_conformance.py"),
    py("scripts/check_transit_evidence_accumulator.py"),
    py("scripts/check_forecast_feature_sources.py"),
    py("scripts/fetch_fmi_weather.py", "--check"),
    py("scripts/check_fmi_weather.py"),
    ...
    py("scripts/generate_pilot_session_brief.py", "--check"),
    py("scripts/check_pilot_session_brief.py"),
    py("scripts/generate_pilot_summary_intake.py", "--check"),
    py("scripts/check_pilot_summary_intake.py"),
    py("scripts/generate_pilot_summary_review.py", "--check"),
    py("scripts/check_pilot_summary_review.py"),
    py("scripts/generate_pilot_summary_template.py", "--check"),
    py("scripts/check_pilot_summary_template.py"),
    ...
    py("scripts/generate_pilot_supervision_status.py", "--check"),
    py("scripts/check_pilot_supervision_status.py"),
