    ...
    return {
        ...
        "smokeChecks": [
            ...
            },
            {
                ...
                "expected": "agent prediction implementation kit exposes the compact manual, question-discovery intake, candidate readbacks, validation reports, adapter guidance, and starter templates without creating forecast artifacts.",
            },
            {
