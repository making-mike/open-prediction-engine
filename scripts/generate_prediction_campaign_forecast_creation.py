...
def check_or_write(data: dict[str, Any], *, write: bool) -> None:
    validate_and_emit(data, SCHEMA, OUTPUT_PATH, write=write, label="prediction campaign forecast creation", regen="python3 scripts/generate_prediction_campaign_forecast_creation.py --write")
